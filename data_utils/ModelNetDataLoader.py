...
class ModelNetDataLoader(Dataset):
    ...
    def __init__(self, root, args, split='train', process_data=False):
        self.root = root # data 폴더 경로
        self.npoints = args.num_point # default 값이 1,024개
        self.process_data = process_data # default 값이 False
        self.uniform = args.use_uniform_sample # default 값은 False. True라면 uniform sampling을 수행
        ...
        if self.num_category == 10:
            ...
            self.catfile = os.path.join(self.root, 'modelnet40_shape_names.txt') # 40개 레이블명을 담은 텍스트 파일
        ...
        shape_ids = {}
        if self.num_category == 10:
            shape_ids['train'] = [line.rstrip() for line in open(os.path.join(self.root, 'modelnet10_train_66.txt'))] # Fine-tune Dataset
    ...
    def _get_item(self, index):
        if self.process_data: # default 값은 False
            ...
            if self.uniform:
                ...
                point_set = point_set[0:self.npoints, :] # 1-npoints개의 point를 sampling
